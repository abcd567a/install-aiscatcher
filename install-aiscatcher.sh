...
echo -e "\e[33m(1) If you have installed a Map Software on RPi(such as AIS Dispatcher or OpenCPN),\e[39m"
...
echo -e "\e[33m    (d) Add following  line after replacing xx.xxx and yy.yyy by their actual valuese:\e[39m"
echo -e "\e[35m          -N STATION MyStation LAT xx.xxx LON yy.yyy \e[39m"
echo -e "\e[33m    (e) For each Site you want to feed AIS data, add a new line in following format:\e[39m"
...
echo " "
echo -e "\e[32m(6) See status\e[39m sudo systemctl status aiscatcher"
echo -e "\e[32m(7) Restart\e[39m    sudo systemctl restart aiscatcher"
echo -e "\e[32m(8) Stop\e[39m       sudo systemctl stop aiscatcher"
