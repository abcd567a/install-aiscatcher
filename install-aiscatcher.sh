...
echo -e "\e[33m(1) The Web Interface (Map etc) is displayed at IP-of-PI:8383 \e[39m"
echo -e "\e[39m     $(ip route | grep -m1 -o -P 'src \K[0-9,.]*'):8383 \e[39m"
echo -e "\e[33m(2) The Map Software installed on RPi(AIS Dispatcher or OpenCPN) should\e[39m"
echo -e "\e[33m    be configured to use UDP Port 10110, IP 127.0.0.1 OR 0.0.0.0\e[39m"
echo -e "\e[33m(3) Open file aiscatcher.conf by following command:\e[39m"
echo -e "\e[39m       sudo nano "${INSTALL_FOLDER}"/aiscatcher.conf \e[39m"
echo -e "\e[33m(4) In above file:\e[39m"
...
echo -e "\e[33m    (c) Change 38.6 in \"-gr TUNER 38.6 RTLAGC off\" to desired Gain of AIS dongle\e[39m"
echo -e "\e[33m    (d) For each Site you want to feed AIS data, add a line immediately\e[39m"
...
echo -e "\e[33m    (e) Save (Ctrl+o) and  Close (Ctrl+x) file aiscatcher.conf \e[39m"

echo -e "\e[01;31m(5) REBOOT RPi \e[39m"
