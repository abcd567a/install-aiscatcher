...
echo -e "\e[33m    (a) Change \"-d 00000162\" to the actual Serial Number of your AIS DVBT dongle\e[39m"
echo -e "\e[33m    (b) For each Site you want to feed AIS data, add a line immediately\e[39m"
...
echo -e "\e[33m    (c) Save (Ctrl+o) and  Close (Ctrl+x) file aiscatcher.conf \e[39m"
