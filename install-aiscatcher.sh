...
echo -e "\e[32m=======================\e[39m"
echo -e "\e[33m(1) The Map Software installed on RPi(AIS Dispatcher or OpenCPN) should\e[39m"
...
echo -e "\e[33m(4) For each Site you want to feed AIS data, add line:\e[39m"
echo -e "\e[33m    immediately below last line in following format:\e[39m"
...
echo -e "\e[33m    Save (Ctrl+o) and  Close (Ctrl+x) file aiscatcher.conf \e[39m"
echo -e "\e[33m(5) Restart AIS-catcher by following command:\e[39m"
